...
const  GenderDetect = () => {
  ...
  const [result, setResult] = useState(null)
    ...
    const handlesubmit = (event) =>{
        ...
        axios.post('https://api.cloudmersive.com/image/face/detect-gender', formData, {
          headers: {
    ...
    return (
        ...
        <div className="text-center mt-4 hover:scale-100  decoration-1  hover:-translate-y-1  hover:skew-y-3  hover:scale-110 hover:rotate-30 underline underline-offset-1 uppercase decoration-solid text-3xl">
            ...
            <div className="flex items-center justify-center w-full mt-5  ">
                ...
                <button type="submit" className=" transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110   duration text-gray-900 bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-100 dark:focus:ring-red-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Guess the gender 	&#129300; </button>
            ...
            <div className="md:flex flex-row  px-24 py-10">
                ...
                {/* results */}
                    ...
                    <div className="m-4 "> 
                        ...
                        {result.PersonWithGender.map((object, i) => (<div key={i}>  
                            
                                <div> for {i+1} st person </div>
                                <div> 
                                    gender : {object.GenderClass } 
                                </div>
                                <div>
                                GenderClassificationConfidence:     
                                {object.GenderClassificationConfidence} 
                                </div>
